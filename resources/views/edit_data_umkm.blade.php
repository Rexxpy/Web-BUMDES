...
<body style="background-color: #eee5e5">
	...
	<div class="main-container">
		...
		<div class="main">
            ...
            <form id="form" action="{{ route('dataumkm.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            @method('PUT')
                ...
                @if ($jenisumkm == 'produk')
                     <div class="umkm-produk" id="umkm-produk">
                        ...
                        <div class="input-nama-produk mt-4">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="text" value="{{ $data->nama_produk }}" class="form-control" placeholder="Isi nama produk" id="inputnamaproduk" name="inputnamaproduk">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-harga-produk mt-3">
                        <div class="input-group mb-3">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="number" value="{{ $data->harga }}" class="form-control" id="inputhargaproduk" name="inputhargaproduk" placeholder="Isi harga produk">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-kontak-penjual mt-3">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="number" value="{{ $data->kontak_penjual }}" class="form-control" placeholder="Isi nomor kontak penjual" id="inputkontakpenjual" name="inputkontakpenjual">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-detail-produk" style="margin-top: 35px">
                        <input id="x" value="{{ $data->deskripsi_produk }}" type="hidden" name="inputdeskripsiproduk">
                    ...
                    <div class="input-gambarproduk mt-3">
                        <div class="input-group mb-3" style="width: 715px">
                            <input type="file" class="form-control" id="inputgambarproduk" name="inputgambarproduk" value="{{ $data->gambar_produk }}">
                  ...
                  <div class="umkm-jasa" id="umkm-jasa">
                    ...
                    <div class="input-nama-jasa mt-4">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="text" value="{{ $data->nama_jasa }}" class="form-control" placeholder="Isi nama jasa" id="inputnamajasa" name="inputnamajasa">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-deskripsi-jasa mt-3">
                        <div class="input-group" style="width: 50%">
                            ...
                            <textarea class="form-control" value="{{ $data->deskripsi_jasa }}" aria-label="With textarea" id="inputdeskripsijasa" name="inputdeskripsijasa"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="input-kontak-penyedia mt-3">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="number" value="{{ $data->kontak_penyedia_jasa }}" class="form-control" placeholder="Isi nomor kontak penyedia jasa" id="inputkontakpenyedia" name="inputkontakpenyedia">
                                </div>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="umkm-wisata" id="umkm-wisata">
                    ...
                    <div class="input-nama-wisata mt-4">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="text" value="{{ $data->nama_wisata }}" class="form-control" placeholder="Isi nama wisata" id="inputnamawisata" name="inputnamawisata">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-deskripsi-wisata mt-3">
                        <div class="input-group" style="width: 50%">
                            ...
                            <textarea class="form-control" value="{{ $data->deskripsi_wisata }}" aria-label="With textarea" id="inputdeskripsiwisata" name="inputdeskripsiwisata"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="input-tarif mt-3">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="number" value="{{ $data->tarif }}" class="form-control" placeholder="Isi tarif wisata" id="inputtarif" name="inputtarif">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-lokasi mt-3">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="number" value="{{ $data->titik_lokasi }}" class="form-control" placeholder="Isi titik lokasi map wisata" id="inputlokasi" name="inputlokasi">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="button-wisata mt-4">
                    <button class="btn b-edit" value="{{ $jenisumkm }}" type="submit"  name="b-edit" style="width: 120px">
                        <b>Edit</b>
                    </button>
                </div>
            </form>
