            ...
            <div class="table-responsive mt-4">
                <table id="tabelkegiatan" class="table table-bordered" style="width:60%;height:10px">
                    ...
                    <tbody>
                        ...
                        <form action="<?php echo e(route('show_edit_kegiatan',[$data->id])); ?>" method="post">
                            <?php echo csrf_field(); ?>        
							<tr style="border:1px solid #0a0a27;">
								<td><center><?php echo e($no++); ?></center></td>
								<td><center><?php echo e($data->nama_kegiatan); ?></center></td>
								<td><center><?php echo e($data->tanggal); ?></center></td>
								<td style="width: 31%">
                                    <button class="btn b-edit" value="kegiatan" name="b-edit"><span class="bi bi-pencil-square"><b> Edit</b></span></button>		
                        </form>
                                <form action="<?php echo e(route('delete_kegiatan',[$data->id])); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH E:\app\bumdestawar\resources\views/data_kegiatan.blade.php ENDPATH**/ ?>