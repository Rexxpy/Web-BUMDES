        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 mt-5">
              <a href="<?php echo e(route('deskripsi_produk', [$data->id])); ?>">
                <img src=<?php echo e(asset('storage/'.$data->gambar_produk)); ?> alt="" srcset="" id="gambar-produk">
              </a>
              <h3 class="text-left mt-3"><b><?php echo e($data->nama_produk); ?></b></h3>
              <h4 class="text-left">Rp. <?php echo e($data->harga); ?></h2>
             </div>
...
</html><?php /**PATH E:\app\bumdestawar\resources\views/produk.blade.php ENDPATH**/ ?>