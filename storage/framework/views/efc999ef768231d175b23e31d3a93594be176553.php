            ...
            <div class="tgl-umkm">
                ...
                <div class="form-tgl mx-4" >
                    <div class="textfield-tgl">
                        ...
                        <div style="display: inline-block;"><input type="text" name="str" id="str"  value="<?php echo e($start); ?>" class="form-control" readonly></div>
                        <div style="display: inline-block;"><p id="textsd" style="font-size: 27px;font-weight:600;color:rgb(43, 43, 43);">s/d </p></div>
                        <div style="display: inline-block;"><input type="text" name="end" id="end"  value="<?php echo e($end); ?>" class="form-control" readonly></div>
                    </div>
                ...
                <div class="table-responsive mt-3">
                    ...
                    <table id="tabeljasa" class="table table-bordered" style="width:70%;">
                        ...
                        <tbody>
                            ...
                            <form action="<?php echo e(route('show_edit',[$data->id])); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <tr style="border:1px solid #0a0a27;">
                                    <td><center><?php echo e($no++); ?></center></td>
                                    <td><center><?php echo e($data->nama_jasa); ?></center></td>
                                    <td><center><?php echo e($data->kontak_penyedia_jasa); ?></center></td>
                                    <td style="width: 26.5%">
                                        <button class="btn b-edit" value="jasa" name="b-edit"><span class="bi bi-pencil-square"><b> Edit</b></span></button>		
                            </form>
                                    <form action="<?php echo e(route('delete_umkm',[$data->id])); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            ...
                            <form action="<?php echo e(route('show_edit',[$data->id])); ?>" method="post">
                             <?php echo csrf_field(); ?>
                                <tr style="border:1px solid #0a0a27;">
                                    <td><center><?php echo e($no++); ?></center></td>
                                    <td><center><?php echo e($data->nama_wisata); ?></center></td>
                                    <td><center><?php echo e($data->tarif); ?></center></td>
                                    <td style="width: 18.5%">
                ...
                <table id="tabelproduk" class="table mx-auto table-bordered" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <?php echo csrf_field(); ?>
                            <tr style="border:1px solid #0a0a27;">
                                <td><center><?php echo e($no++); ?></center></td>
                                <td><center><?php echo e($data->jenis_produk); ?></center></td>
                                <td><center><?php echo e($data->nama_produk); ?></center></td>
                                <td><center><?php echo e($data->harga); ?></center></td>
                                <td><center><?php echo e($data->kontak_penjual); ?></center></td>
                                <td style="width: 18.5%">
...
</html><?php /**PATH E:\app\bumdestawar\resources\views/data_umkm.blade.php ENDPATH**/ ?>