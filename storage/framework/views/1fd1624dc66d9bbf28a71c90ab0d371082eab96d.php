      ...
      <div class="wisata mt-5">
        <div class="container">
          <div class="row" style="display:flex;justify-content: center;align-items: center;">  
            <?php $__currentLoopData = $datawisata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
              <div class="col-sm-auto image-1">
                <a href="<?php echo e(route('deskripsi_wisata', [$data->id])); ?>">
                  
                  <h1 style="color: aliceblue"><?php echo e($data->nama_wisata); ?></h1>
                </a>     
              </div>
...
</html><?php /**PATH E:\app\bumdestawar\resources\views/wisata.blade.php ENDPATH**/ ?>