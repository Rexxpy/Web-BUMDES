  ...
  <div class="se-pre-con"></div>
    ...
    <nav class="navbar navbar-expand-sm fixed-top">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item text-center">
            <?php $__currentLoopData = $dataumkm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                
              <img class="d-block w-100" src=<?php echo e(asset('storage/'.$data->gambar_produk)); ?> alt="" style="opacity: 0.4;">
      ...
      <div class="kegiatan">
        <div class="container">
          <div class="row">
              <div class="head-kegiatan text-center mb-3">
    ...
    <script>
       ...
       const elemen4 = document.querySelector('.body-kegiatan');
...
</html><?php /**PATH E:\app\bumdestawar\resources\views/home.blade.php ENDPATH**/ ?>