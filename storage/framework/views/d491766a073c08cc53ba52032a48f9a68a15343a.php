...
<body style="background-color: #eee5e5">
	...
	<div class="main-container">
		...
		<div class="main">
			<h2 style="font-weight: 700">Selamat datang, <?php echo e(auth()->user()->namalengkap); ?></h2>		
						...
						<div class="row mx-1" style="margin-left: 10px;">
							<div class="col-md-4 ">
								<div class="row">
									...
									<div class="col-md-3 text-left">
										<h1 id="counter" data-count="<?php echo e($jumlahproduk); ?>">0</h1>
										<p><b>Produk</b></p>
									</div>
								</div>
							</div>
							<div class="col-md-4 ">
								<div class="row">
									...
									<div class="col-md-3 text-left">
										<h1 id="counter2" data-count2="<?php echo e($jumlahjasa); ?>">0</h1>
										<p><b>Jasa</b></p>
									</div>
								</div>
							</div>
							<div class="col-md-4 ">
								<div class="row">
									...
									<div class="col-md-3 text-left">
										<h1 id="counter3" data-count3="<?php echo e($jumlahwisata); ?>">0</h1>
										<p><b>Wisata</b></p>
									</div>
								</div>
							</div>
						...
						<div class="row" style="margin-left: 20px;">		
							<?php $__currentLoopData = $datakegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>		
								<div class="col-md-4 text-left">
									<img src=<?php echo e(asset('storage/'.$data->galeri_kegiatan)); ?> class="img-responsive" id="gambar-kegiatan">
									<h6><b><?php echo e($data->nama_kegiatan); ?></b></h6>
...
</html><?php /**PATH E:\app\bumdestawar\resources\views/dashboard.blade.php ENDPATH**/ ?>