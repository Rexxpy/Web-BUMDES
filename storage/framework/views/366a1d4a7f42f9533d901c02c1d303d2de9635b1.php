...
<body style="background-color: #eee5e5">
  ...
  <div class="se-pre-con"></div>
    ...
    <?php $__currentLoopData = $datajasa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
      <div class="jasa mt-5">
        <div class="container">
          <div class="row">
              <div class="col-md-5 text-center">
                  <img src=<?php echo e(asset('storage/'.$data->gambar_jasa)); ?> class="img-responsive" alt="logo" id="gambar-jasa">
              </div>
              <div class="col-md-7 text-left">
                <h2 class="text-left mb-3"><b><?php echo e($data->nama_jasa); ?></b></h2>
                <h4 class="text-left mt-1"><?php echo $data->deskripsi_jasa; ?></h4>
                <a href="//api.whatsapp.com/send?phone=<?php echo e($data->kontak_penyedia_jasa); ?>&text=Halo saya membutuhkan jasa <?php echo e($data->nama_jasa); ?>" target="_blank">  
...
</html><?php /**PATH E:\app\bumdestawar\resources\views/jasa.blade.php ENDPATH**/ ?>