...
<body style="background-color: #eee5e5">
	...
	<div class="main-container">
		...
		<div class="main">
            ...
            <?php $__currentLoopData = $dataumkm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            
            <form id="form" action="<?php echo e(route('dataumkm.update', $data->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>

            <?php echo method_field('PUT'); ?>


                <?php if($jenisumkm == 'produk'): ?>
                     <div class="umkm-produk" id="umkm-produk">
                        ...
                        <div class="input-nama-produk mt-4">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="text" value="<?php echo e($data->nama_produk); ?>" class="form-control" placeholder="Isi nama produk" id="inputnamaproduk" name="inputnamaproduk">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-harga-produk mt-3">
                        <div class="input-group mb-3">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="number" value="<?php echo e($data->harga); ?>" class="form-control" id="inputhargaproduk" name="inputhargaproduk" placeholder="Isi harga produk">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-kontak-penjual mt-3">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="number" value="<?php echo e($data->kontak_penjual); ?>" class="form-control" placeholder="Isi nomor kontak penjual" id="inputkontakpenjual" name="inputkontakpenjual">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-detail-produk" style="margin-top: 35px">
                        <input id="x" value="<?php echo e($data->deskripsi_produk); ?>" type="hidden" name="inputdeskripsiproduk">
                    ...
                    <div class="input-gambarproduk mt-3">
                        <div class="input-group mb-3" style="width: 715px">
                            <input type="file" class="form-control" id="inputgambarproduk" name="inputgambarproduk" value="<?php echo e($data->gambar_produk); ?>">
                ...
                <?php elseif($jenisumkm == 'jasa'): ?>
                  <div class="umkm-jasa" id="umkm-jasa">
                    ...
                    <div class="input-nama-jasa mt-4">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="text" value="<?php echo e($data->nama_jasa); ?>" class="form-control" placeholder="Isi nama jasa" id="inputnamajasa" name="inputnamajasa">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-deskripsi-jasa mt-3">
                        <div class="input-group" style="width: 50%">
                            ...
                            <textarea class="form-control" value="<?php echo e($data->deskripsi_jasa); ?>" aria-label="With textarea" id="inputdeskripsijasa" name="inputdeskripsijasa"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="input-kontak-penyedia mt-3">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="number" value="<?php echo e($data->kontak_penyedia_jasa); ?>" class="form-control" placeholder="Isi nomor kontak penyedia jasa" id="inputkontakpenyedia" name="inputkontakpenyedia">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <?php else: ?>
                  <div class="umkm-wisata" id="umkm-wisata">
                    ...
                    <div class="input-nama-wisata mt-4">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="text" value="<?php echo e($data->nama_wisata); ?>" class="form-control" placeholder="Isi nama wisata" id="inputnamawisata" name="inputnamawisata">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-deskripsi-wisata mt-3">
                        <div class="input-group" style="width: 50%">
                            ...
                            <textarea class="form-control" value="<?php echo e($data->deskripsi_wisata); ?>" aria-label="With textarea" id="inputdeskripsiwisata" name="inputdeskripsiwisata"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="input-tarif mt-3">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="number" value="<?php echo e($data->tarif); ?>" class="form-control" placeholder="Isi tarif wisata" id="inputtarif" name="inputtarif">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-lokasi mt-3">
                        <div class="input-group">
                            ...
                            <div class="form-floating">
                                <div class="col-pd-3">
                                    <input type="number" value="<?php echo e($data->titik_lokasi); ?>" class="form-control" placeholder="Isi titik lokasi map wisata" id="inputlokasi" name="inputlokasi">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="button-wisata mt-4">
                    <button class="btn b-edit" value="<?php echo e($jenisumkm); ?>" type="submit"  name="b-edit" style="width: 120px">
                        <b>Edit</b>
                    </button>
                </div>
            </form>
...
</html><?php /**PATH E:\app\bumdestawar\resources\views/edit_data_umkm.blade.php ENDPATH**/ ?>